 ...
 * @property (object{identifier: string}&\PublishPress\Stripe\StripeObject) $cancel Specifies which event to cancel.
 ...
 */
class MeterEventAdjustment extends \PublishPress\Stripe\ApiResource
{
