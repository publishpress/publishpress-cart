 ...
 */
class TestClockService extends \PublishPress\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \PublishPress\Stripe\TestHelpers\TestClock
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\TestHelpers\TestClock>
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
