...
class ApplicationFeeService extends AbstractService
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\ApplicationFee>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\ApplicationFeeRefund>
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\ApplicationFeeRefund
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\ApplicationFee
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
