 ...
 * @property (object{event_payload_key: string, type: string}&\PublishPress\Stripe\StripeObject) $customer_mapping
 * @property (object{formula: string}&\PublishPress\Stripe\StripeObject) $default_aggregation
 ...
 * @property (object{deactivated_at: null|int}&\PublishPress\Stripe\StripeObject) $status_transitions
 * @property int $updated Time at which the object was last updated. Measured in seconds since the Unix epoch.
 * @property (object{event_payload_key: string}&\PublishPress\Stripe\StripeObject) $value_settings
 */
class Meter extends \PublishPress\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';

    use \PublishPress\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \PublishPress\Stripe\Collection<Meter> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<MeterEventSummary> the list of meter event summaries
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
