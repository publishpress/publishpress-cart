 ...
 * @property null|(object{issuing_dispute: null|string}&\PublishPress\Stripe\StripeObject) $linked_flows Other flows linked to a DebitReversal.
 ...
 * @property (object{completed_at: null|int}&\PublishPress\Stripe\StripeObject) $status_transitions
 * @property null|string|Transaction $transaction The Transaction associated with this object.
 */
class DebitReversal extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<DebitReversal> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
