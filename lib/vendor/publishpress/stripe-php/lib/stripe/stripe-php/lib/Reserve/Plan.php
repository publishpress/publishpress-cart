 ...
 * @property null|(object{release_after: int, scheduled_release: int}&\PublishPress\Stripe\StripeObject) $fixed_release
 ...
 * @property null|(object{days_after_charge: int, expires_on: null|int}&\PublishPress\Stripe\StripeObject) $rolling_release
 ...
 */
class Plan extends \PublishPress\Stripe\ApiResource
{
