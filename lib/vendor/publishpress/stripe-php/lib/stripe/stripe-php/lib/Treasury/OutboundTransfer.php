 ...
 * @property (object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PublishPress\Stripe\StripeObject), email: null|string, name: null|string}&\PublishPress\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\PublishPress\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\PublishPress\Stripe\Mandate, network: string, routing_number: null|string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $destination_payment_method_details
 ...
 * @property null|(object{code: string, transaction: string|Transaction}&\PublishPress\Stripe\StripeObject) $returned_details Details about a returned OutboundTransfer. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundTransfer extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<OutboundTransfer> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
