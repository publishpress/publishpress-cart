 ...
 * @property ((object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\PublishPress\Stripe\StripeObject))[] $locations The locations in which this supplier operates.
 ...
 */
class Supplier extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<Supplier> of ApiResources
     *
