...
class PriceService extends AbstractService
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\Price>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Price
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\SearchResult<\PublishPress\Stripe\Price>
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
