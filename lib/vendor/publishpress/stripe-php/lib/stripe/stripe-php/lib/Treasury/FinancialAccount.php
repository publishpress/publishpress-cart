 ...
 * @property (object{cash: \PublishPress\Stripe\StripeObject, inbound_pending: \PublishPress\Stripe\StripeObject, outbound_pending: \PublishPress\Stripe\StripeObject}&\PublishPress\Stripe\StripeObject) $balance Balance information for the FinancialAccount
 ...
 * @property ((object{aba?: (object{account_holder_name: string, account_number?: null|string, account_number_last4: string, bank_name: string, routing_number: string}&\PublishPress\Stripe\StripeObject), supported_networks?: string[], type: string}&\PublishPress\Stripe\StripeObject))[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|(object{inbound_flows: null|string, outbound_flows: null|string}&\PublishPress\Stripe\StripeObject) $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property (object{closed: null|(object{reasons: string[]}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $status_details
 ...
 */
class FinancialAccount extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<FinancialAccount> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \PublishPress\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
