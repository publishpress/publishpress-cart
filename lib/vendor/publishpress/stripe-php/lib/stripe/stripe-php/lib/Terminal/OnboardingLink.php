 ...
 * @property (object{apple_terms_and_conditions: null|(object{allow_relinking: null|bool, merchant_display_name: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $link_options Link type options associated with the current onboarding link object.
 ...
 */
class OnboardingLink extends \PublishPress\Stripe\ApiResource
{
