 ...
 */
class TokenService extends \PublishPress\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\Issuing\Token>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Issuing\Token
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
