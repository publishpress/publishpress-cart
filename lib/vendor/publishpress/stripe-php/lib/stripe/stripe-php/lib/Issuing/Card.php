 ...
 * @property null|(object{started_at: null|int, type: null|string}&\PublishPress\Stripe\StripeObject) $latest_fraud_warning Stripe’s assessment of whether this card’s details have been compromised. If this property isn't null, cancel and reissue the card to prevent fraudulent activity risk.
 * @property null|(object{cancel_after: (object{payment_count: int}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $lifecycle_controls Rules that control the lifecycle of this card, such as automatic cancellation. Refer to our <a href="/issuing/controls/lifecycle-controls">documentation</a> for more details.
 ...
 * @property null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PublishPress\Stripe\StripeObject), address_validation: null|(object{mode: string, normalized_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PublishPress\Stripe\StripeObject), result: null|string}&\PublishPress\Stripe\StripeObject), carrier: null|string, customs: null|(object{eori_number: null|string}&\PublishPress\Stripe\StripeObject), eta: null|int, name: string, phone_number: null|string, require_signature: null|bool, service: string, status: null|string, tracking_number: null|string, tracking_url: null|string, type: string}&\PublishPress\Stripe\StripeObject) $shipping Where and how the card will be shipped.
 * @property (object{allowed_card_presences: null|string[], allowed_categories: null|string[], allowed_merchant_countries: null|string[], blocked_card_presences: null|string[], blocked_categories: null|string[], blocked_merchant_countries: null|string[], spending_limits: null|((object{amount: int, categories: null|string[], interval: string}&\PublishPress\Stripe\StripeObject))[], spending_limits_currency: null|string}&\PublishPress\Stripe\StripeObject) $spending_controls
 ...
 * @property null|(object{apple_pay: (object{eligible: bool, ineligible_reason: null|string}&\PublishPress\Stripe\StripeObject), google_pay: (object{eligible: bool, ineligible_reason: null|string}&\PublishPress\Stripe\StripeObject), primary_account_identifier: null|string}&\PublishPress\Stripe\StripeObject) $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<Card> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
