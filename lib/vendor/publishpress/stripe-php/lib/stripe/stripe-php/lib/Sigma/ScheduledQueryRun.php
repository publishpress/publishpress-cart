...
namespace PublishPress\Stripe\Sigma;
 ...
 * @property null|(object{message: string}&\PublishPress\Stripe\StripeObject) $error
 * @property null|\PublishPress\Stripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<ScheduledQueryRun> of ApiResources
     *
