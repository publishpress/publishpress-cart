...
namespace PublishPress\Stripe\Service\FinancialConnections;
...
class AccountService extends \PublishPress\Stripe\Service\AbstractService
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\FinancialConnections\Account>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\FinancialConnections\AccountOwner>
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\FinancialConnections\Account
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
