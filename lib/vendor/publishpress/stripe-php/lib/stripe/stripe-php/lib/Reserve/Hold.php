...
namespace PublishPress\Stripe\Reserve;
 ...
 * @property null|(object{amount: int, reserve_release: string}&\PublishPress\Stripe\StripeObject)[] $release_details List of ReserveReleases and the amounts released from this ReserveHold.
 * @property (object{release_after: null|int, scheduled_release: null|int}&\PublishPress\Stripe\StripeObject) $release_schedule
 * @property null|Plan|string $reserve_plan The ReservePlan which produced this ReserveHold (i.e., resplan_123)
 * @property null|string|\PublishPress\Stripe\Charge $source_charge The Charge which funded this ReserveHold (e.g., ch_123)
 ...
 */
class Hold extends \PublishPress\Stripe\ApiResource
{
