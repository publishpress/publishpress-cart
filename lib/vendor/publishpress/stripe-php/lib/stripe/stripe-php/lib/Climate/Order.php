...
namespace PublishPress\Stripe\Climate;
 ...
 * @property null|(object{public_name: string}&\PublishPress\Stripe\StripeObject) $beneficiary
 ...
 * @property ((object{delivered_at: int, location: null|(object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\PublishPress\Stripe\StripeObject), metric_tons: string, registry_url: null|string, supplier: Supplier}&\PublishPress\Stripe\StripeObject))[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 */
class Order extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<Order> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
