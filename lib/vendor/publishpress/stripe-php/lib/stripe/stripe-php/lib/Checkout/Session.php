...
namespace PublishPress\Stripe\Checkout;
 ...
 * @property null|(object{enabled: bool}&\PublishPress\Stripe\StripeObject) $adaptive_pricing Settings for price localization with <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a>.
 * @property null|(object{recovery: null|(object{allow_promotion_codes: bool, enabled: bool, expires_at: null|int, url: null|string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property (object{enabled: bool, liability: null|(object{account?: string|\PublishPress\Stripe\Account, type: string}&\PublishPress\Stripe\StripeObject), provider: null|string, status: null|string}&\PublishPress\Stripe\StripeObject) $automatic_tax
 ...
 * @property null|(object{background_color: string, border_style: string, button_color: string, display_name: string, font_family: string, icon: null|(object{file?: string, type: string, url?: string}&\PublishPress\Stripe\StripeObject), logo: null|(object{file?: string, type: string, url?: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $branding_settings
 ...
 * @property null|string $client_secret The client secret of your Checkout Session. Applies to Checkout Sessions with <code>ui_mode: embedded_page</code> or <code>ui_mode: elements</code>. For <code>ui_mode: embedded_page</code>, the client secret is to be used when initializing Stripe.js embedded checkout. For <code>ui_mode: elements</code>, use the client secret with <a href="https://docs.stripe.com/js/custom_checkout/init">initCheckout</a> on your front end.
 * @property null|(object{business_name: null|string, individual_name: null|string, shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PublishPress\Stripe\StripeObject), name: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $collected_information Information about the customer collected within the Checkout Session.
 * @property null|(object{promotions: null|string, terms_of_service: null|string}&\PublishPress\Stripe\StripeObject) $consent Results of <code>consent_collection</code> for this session.
 * @property null|(object{payment_method_reuse_agreement: null|(object{position: string}&\PublishPress\Stripe\StripeObject), promotions: null|string, terms_of_service: null|string}&\PublishPress\Stripe\StripeObject) $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|(object{amount_subtotal: int, amount_total: int, fx_rate: string, source_currency: string}&\PublishPress\Stripe\StripeObject) $currency_conversion Currency conversion details for <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a> sessions created before 2025-03-31.
 * @property ((object{dropdown?: (object{default_value: null|string, options: (object{label: string, value: string}&\PublishPress\Stripe\StripeObject)[], value: null|string}&\PublishPress\Stripe\StripeObject), key: string, label: (object{custom: null|string, type: string}&\PublishPress\Stripe\StripeObject), numeric?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\PublishPress\Stripe\StripeObject), optional: bool, text?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\PublishPress\Stripe\StripeObject), type: string}&\PublishPress\Stripe\StripeObject))[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported. You can't set this parameter if <code>ui_mode</code> is <code>custom</code>.
 * @property (object{after_submit: null|(object{message: string}&\PublishPress\Stripe\StripeObject), shipping_address: null|(object{message: string}&\PublishPress\Stripe\StripeObject), submit: null|(object{message: string}&\PublishPress\Stripe\StripeObject), terms_of_service_acceptance: null|(object{message: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $custom_text
 * @property null|string|\PublishPress\Stripe\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>subscription</code> mode or Checkout Sessions with <code>customer_creation</code> set as <code>always</code> in <code>payment</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PublishPress\Stripe\StripeObject), business_name: null|string, email: null|string, individual_name: null|string, name: null|string, phone: null|string, tax_exempt: null|string, tax_ids: null|((object{type: string, value: null|string}&\PublishPress\Stripe\StripeObject))[]}&\PublishPress\Stripe\StripeObject) $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Customer's address details are not present on Sessions in <code>setup</code> mode.
 ...
 * @property null|((object{coupon: null|string|\PublishPress\Stripe\Coupon, promotion_code: null|string|\PublishPress\Stripe\PromotionCode}&\PublishPress\Stripe\StripeObject))[] $discounts List of coupons and promotion codes attached to the Checkout Session.
 ...
 * @property null|string|\PublishPress\Stripe\Invoice $invoice ID of the invoice created by the Checkout Session, if it exists.
 * @property null|(object{enabled: bool, invoice_data: (object{account_tax_ids: null|(string|\PublishPress\Stripe\TaxId)[], custom_fields: null|(object{name: string, value: string}&\PublishPress\Stripe\StripeObject)[], description: null|string, footer: null|string, issuer: null|(object{account?: string|\PublishPress\Stripe\Account, type: string}&\PublishPress\Stripe\StripeObject), metadata: null|\PublishPress\Stripe\StripeObject, rendering_options: null|(object{amount_tax_display: null|string, template: null|string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $invoice_creation Details on the state of invoice creation for the Checkout Session.
 * @property null|\PublishPress\Stripe\Collection<\PublishPress\Stripe\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|(object{enabled: bool}&\PublishPress\Stripe\StripeObject) $managed_payments Settings for Managed Payments for this Checkout Session and resulting <a href="/api/payment_intents/object">PaymentIntents</a>, <a href="/api/invoices/object">Invoices</a>, and <a href="/api/subscriptions/object">Subscriptions</a>.
 * @property null|\PublishPress\Stripe\StripeObject $metadata Set of <a href="https://docs.stripe.com/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 * @property string $mode The mode of the Checkout Session.
 * @property null|(object{business?: (object{enabled: bool, optional: bool}&\PublishPress\Stripe\StripeObject), individual?: (object{enabled: bool, optional: bool}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $name_collection
 * @property null|((object{adjustable_quantity: null|(object{enabled: bool, maximum: null|int, minimum: null|int}&\PublishPress\Stripe\StripeObject), price: string, quantity: int}&\PublishPress\Stripe\StripeObject))[] $optional_items The optional items presented to the customer at checkout.
 ...
 * @property null|string|\PublishPress\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode. You can't confirm or cancel the PaymentIntent for a Checkout Session. To cancel, <a href="https://docs.stripe.com/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|string|\PublishPress\Stripe\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 ...
 * @property null|(object{id: string, parent: null|string}&\PublishPress\Stripe\StripeObject) $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 * @property null|(object{acss_debit?: (object{currency?: string, mandate_options?: (object{custom_mandate_url?: string, default_for?: string[], interval_description: null|string, payment_schedule: null|string, transaction_type: null|string}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\PublishPress\Stripe\StripeObject), affirm?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), afterpay_clearpay?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), alipay?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), alma?: (object{capture_method?: string}&\PublishPress\Stripe\StripeObject), amazon_pay?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), au_becs_debit?: (object{setup_future_usage?: string, target_date?: string}&\PublishPress\Stripe\StripeObject), bacs_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\PublishPress\Stripe\StripeObject), bancontact?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), billie?: (object{capture_method?: string}&\PublishPress\Stripe\StripeObject), boleto?: (object{expires_after_days: int, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), card?: (object{capture_method?: string, installments?: (object{enabled?: bool}&\PublishPress\Stripe\StripeObject), request_extended_authorization?: string, request_incremental_authorization?: string, request_multicapture?: string, request_overcapture?: string, request_three_d_secure: string, restrictions?: (object{brands_blocked?: string[]}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string, statement_descriptor_suffix_kana?: string, statement_descriptor_suffix_kanji?: string}&\PublishPress\Stripe\StripeObject), cashapp?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), customer_balance?: (object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\PublishPress\Stripe\StripeObject), requested_address_types?: string[], type: null|string}&\PublishPress\Stripe\StripeObject), funding_type: null|string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), eps?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), fpx?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), giropay?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), grabpay?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), ideal?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), kakao_pay?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), klarna?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), konbini?: (object{expires_after_days: null|int, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), kr_card?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), link?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), mobilepay?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), multibanco?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), naver_pay?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), oxxo?: (object{expires_after_days: int, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), p24?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), payco?: (object{capture_method?: string}&\PublishPress\Stripe\StripeObject), paynow?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), paypal?: (object{capture_method?: string, preferred_locale: null|string, reference: null|string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), payto?: (object{mandate_options?: (object{amount: null|int, amount_type: null|string, end_date: null|string, payment_schedule: null|string, payments_per_period: null|int, purpose: null|string, start_date: null|string}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), pix?: (object{amount_includes_iof?: string, expires_after_seconds: null|int, mandate_options?: (object{amount?: int, amount_includes_iof?: string, amount_type?: string, currency?: string, end_date?: string, payment_schedule?: string, reference?: string, start_date?: string}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), revolut_pay?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), samsung_pay?: (object{capture_method?: string}&\PublishPress\Stripe\StripeObject), satispay?: (object{capture_method?: string}&\PublishPress\Stripe\StripeObject), scalapay?: (object{capture_method?: string}&\PublishPress\Stripe\StripeObject), sepa_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\PublishPress\Stripe\StripeObject), sofort?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), sunbit?: (object{capture_method?: string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), swish?: (object{reference: null|string}&\PublishPress\Stripe\StripeObject), twint?: (object{setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), upi?: (object{mandate_options?: (object{amount: null|int, amount_type: null|string, description: null|string, end_date: null|int}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string}&\PublishPress\Stripe\StripeObject), us_bank_account?: (object{financial_connections?: (object{filters?: (object{account_subcategories?: string[]}&\PublishPress\Stripe\StripeObject), permissions?: string[], prefetch: null|string[], return_url?: string}&\PublishPress\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\PublishPress\Stripe\StripeObject), wechat_pay?: (object{app_id: null|string, client: null|string, setup_future_usage?: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|(object{update_shipping_details: null|string}&\PublishPress\Stripe\StripeObject) $permissions <p>This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.</p><p>For specific permissions, please refer to their dedicated subsections, such as <code>permissions.update_shipping_details</code>.</p>
 * @property null|(object{enabled: bool}&\PublishPress\Stripe\StripeObject) $phone_number_collection
 * @property null|(object{presentment_amount: int, presentment_currency: string}&\PublishPress\Stripe\StripeObject) $presentment_details
 * @property null|string $recovered_from The ID of the original expired Checkout Session that triggered the recovery flow.
 * @property null|string $redirect_on_completion This parameter applies to <code>ui_mode: embedded_page</code>. Learn more about the <a href="https://docs.stripe.com/payments/checkout/custom-success-page?payment-ui=embedded-form">redirect behavior</a> of embedded sessions. Defaults to <code>always</code>.
 * @property null|string $return_url Applies to Checkout Sessions with <code>ui_mode: embedded_page</code> or <code>ui_mode: elements</code>. The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method's app or site.
 * @property null|(object{allow_redisplay_filters: null|string[], payment_method_remove: null|string, payment_method_save: null|string}&\PublishPress\Stripe\StripeObject) $saved_payment_method_options Controls saved payment method settings for the session. Only available in <code>payment</code> and <code>subscription</code> mode.
 * @property null|string|\PublishPress\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode. You can't confirm or cancel the SetupIntent for a Checkout Session. To cancel, <a href="https://docs.stripe.com/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|(object{allowed_countries: string[]}&\PublishPress\Stripe\StripeObject) $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|(object{amount_subtotal: int, amount_tax: int, amount_total: int, shipping_rate: null|string|\PublishPress\Stripe\ShippingRate, taxes?: ((object{amount: int, rate: \PublishPress\Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\PublishPress\Stripe\StripeObject))[]}&\PublishPress\Stripe\StripeObject) $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property ((object{shipping_amount: int, shipping_rate: string|\PublishPress\Stripe\ShippingRate}&\PublishPress\Stripe\StripeObject))[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|string|\PublishPress\Stripe\Subscription $subscription The ID of the <a href="https://docs.stripe.com/api/subscriptions">Subscription</a> for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|(object{enabled: bool, required: string}&\PublishPress\Stripe\StripeObject) $tax_id_collection
 * @property null|(object{amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: \PublishPress\Stripe\Discount}&\PublishPress\Stripe\StripeObject)[], taxes: ((object{amount: int, rate: \PublishPress\Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\PublishPress\Stripe\StripeObject))[]}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $total_details Tax and discount details for the computed total amount.
 * @property null|string $ui_mode The UI mode of the Session. Defaults to <code>hosted_page</code>.
 * @property null|string $url The URL to the Checkout Session. Applies to Checkout Sessions with <code>ui_mode: hosted_page</code>. Redirect customers to this URL to take them to Checkout. If you’re using <a href="https://docs.stripe.com/payments/checkout/custom-domains">Custom Domains</a>, the URL will use your subdomain. Otherwise, it’ll use <code>checkout.stripe.com.</code> This value is only present when the session is active.
 * @property null|(object{link?: (object{display?: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $wallet_options Wallet-specific configuration for this Checkout Session.
 */
class Session extends \PublishPress\Stripe\ApiResource
{
    const OBJECT_NAME = 'checkout.session';

    use \PublishPress\Stripe\ApiOperations\Update;
     ...
     *
     * @return \PublishPress\Stripe\Collection<Session> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\LineItem> list of line items
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
