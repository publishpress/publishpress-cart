...
namespace PublishPress\Stripe\V2\Billing;
 ...
 * @property \PublishPress\Stripe\StripeObject $payload The payload of the event. This must contain the fields corresponding to a meter’s <code>customer_mapping.event_payload_key</code> (default is <code>stripe_customer_id</code>) and <code>value_settings.event_payload_key</code> (default is <code>value</code>). Read more about the <a href="https://docs.stripe.com/billing/subscriptions/usage-based/recording-usage#payload-key-overrides">payload</a>..
 ...
 */
class MeterEvent extends \PublishPress\Stripe\ApiResource
{
