...
namespace PublishPress\Stripe\Apps;
 ...
 * @property (object{type: string, user?: string}&\PublishPress\Stripe\StripeObject) $scope
 */
class Secret extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<Secret> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
