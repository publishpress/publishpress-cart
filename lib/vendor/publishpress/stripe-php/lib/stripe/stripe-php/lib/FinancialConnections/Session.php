 ...
 * @property null|(object{account?: string|\PublishPress\Stripe\Account, customer?: string|\PublishPress\Stripe\Customer, customer_account?: string, type: string}&\PublishPress\Stripe\StripeObject) $account_holder The account holder for whom accounts are collected in this session.
 * @property \PublishPress\Stripe\Collection<Account> $accounts The accounts that were collected as part of this Session.
 * @property null|string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|(object{account_subcategories: null|string[], countries: null|string[]}&\PublishPress\Stripe\StripeObject) $filters
