...
namespace PublishPress\Stripe\Exception;
...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|array|\PublishPress\Stripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\PublishPress\Stripe\ErrorObject
     */
     ...
     *
     * @param null|\PublishPress\Stripe\ErrorObject $error
     */
     ...
     *
     * @return null|array|\PublishPress\Stripe\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\PublishPress\Stripe\Util\CaseInsensitiveArray $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \PublishPress\Stripe\ErrorObject} for possible
     * values.
     *
     * @return null|string
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \PublishPress\Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
