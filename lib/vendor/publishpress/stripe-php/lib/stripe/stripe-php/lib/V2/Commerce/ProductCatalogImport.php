...
namespace PublishPress\Stripe\V2\Commerce;
 ...
 * @property \PublishPress\Stripe\StripeObject $metadata Additional information about the object in a structured format.
 ...
 * @property null|(object{awaiting_upload?: (object{upload_url: (object{expires_at: int, url: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject), failed?: (object{code: string, failure_message: string, type: string}&\PublishPress\Stripe\StripeObject), processing?: (object{error_count: int, success_count: int}&\PublishPress\Stripe\StripeObject), succeeded?: (object{success_count: int}&\PublishPress\Stripe\StripeObject), succeeded_with_errors?: (object{error_count: int, error_file: (object{content_type: string, download_url: (object{expires_at: int, url: string}&\PublishPress\Stripe\StripeObject), size: int}&\PublishPress\Stripe\StripeObject), samples: (object{error_message: string, field: string, id: string, row: int}&\PublishPress\Stripe\StripeObject)[], success_count: int}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $status_details Details about the current import status.
 */
class ProductCatalogImport extends \PublishPress\Stripe\ApiResource
{
