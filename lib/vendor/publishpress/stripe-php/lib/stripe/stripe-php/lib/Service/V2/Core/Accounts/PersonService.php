...
namespace PublishPress\Stripe\Service\V2\Core\Accounts;
 ...
 */
class PersonService extends \PublishPress\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \PublishPress\Stripe\V2\Collection<\PublishPress\Stripe\V2\Core\AccountPerson>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\V2\DeletedObject
     *
     * @throws \PublishPress\Stripe\Exception\RateLimitException
     */
