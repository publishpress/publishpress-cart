 ...
 * @property null|(object{amount?: int, description?: string, destination: Account|string, metadata?: StripeObject, payment_data?: (object{description?: string, metadata?: StripeObject}&StripeObject)}&StripeObject) $transfer_data The data that automatically creates a Transfer after the payment finalizes. Learn more about the <a href="https://docs.stripe.com/payments/connected-accounts">use case for connected accounts</a>.
