...
namespace PublishPress\Stripe;

use PublishPress\Stripe\Util\Util;
...
class BaseStripeClient implements StripeClientInterface, StripeStreamingClientInterface
{
    ...
    const DEFAULT_CONFIG = [
        ...
        'stripe_account' => null,
        'stripe_context' => null,
        'stripe_version' => \PublishPress\Stripe\Util\ApiVersion::CURRENT,
    ...
    /** @var \PublishPress\Stripe\Util\RequestOptions */
    private $defaultOpts;
     ...
     * - stripe_context (null|string|\PublishPress\Stripe\StripeContext): a Stripe account or compartment ID. If set, all requests sent by the client
    ...
    public function __construct($config = [])
    {
        ...
        $this->defaultOpts = \PublishPress\Stripe\Util\RequestOptions::parse([
    ...
    /**
     * Returns a \PublishPress\Stripe\V2\Core\Events instance using the provided JSON payload. Throws an
