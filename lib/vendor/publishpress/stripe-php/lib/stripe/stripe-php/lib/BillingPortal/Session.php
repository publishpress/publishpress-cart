 ...
 * @property null|(object{after_completion: (object{hosted_confirmation: null|(object{custom_message: null|string}&\PublishPress\Stripe\StripeObject), redirect: null|(object{return_url: string}&\PublishPress\Stripe\StripeObject), type: string}&\PublishPress\Stripe\StripeObject), subscription_cancel: null|(object{retention: null|(object{coupon_offer: null|(object{coupon: string}&\PublishPress\Stripe\StripeObject), type: string}&\PublishPress\Stripe\StripeObject), subscription: string}&\PublishPress\Stripe\StripeObject), subscription_update: null|(object{subscription: string}&\PublishPress\Stripe\StripeObject), subscription_update_confirm: null|(object{discounts: null|((object{coupon: null|string, promotion_code: null|string}&\PublishPress\Stripe\StripeObject))[], items: ((object{id: null|string, price: null|string, quantity?: int}&\PublishPress\Stripe\StripeObject))[], subscription: string}&\PublishPress\Stripe\StripeObject), type: string}&\PublishPress\Stripe\StripeObject) $flow Information about a specific flow for the customer to go through. See the <a href="https://docs.stripe.com/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
