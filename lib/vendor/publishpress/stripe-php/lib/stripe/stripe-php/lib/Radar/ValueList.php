 ...
 * @property \PublishPress\Stripe\Collection<ValueListItem> $list_items List of items contained within this value list.
 ...
 */
class ValueList extends \PublishPress\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<ValueList> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
