...
class ChargeService extends AbstractService
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\Charge>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Charge
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\SearchResult<\PublishPress\Stripe\Charge>
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
