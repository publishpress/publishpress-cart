...
namespace PublishPress\Stripe\FinancialConnections;
 ...
 * @property null|(object{account?: string|\PublishPress\Stripe\Account, customer?: string|\PublishPress\Stripe\Customer, customer_account?: string, type: string}&\PublishPress\Stripe\StripeObject) $account_holder The account holder that this account belongs to.
 * @property null|((object{expected_expiry_date: null|int, identifier_type: string, status: string, supported_networks: string[]}&\PublishPress\Stripe\StripeObject))[] $account_numbers Details about the account numbers.
 * @property null|(object{as_of: int, cash?: (object{available: null|\PublishPress\Stripe\StripeObject}&\PublishPress\Stripe\StripeObject), credit?: (object{used: null|\PublishPress\Stripe\StripeObject}&\PublishPress\Stripe\StripeObject), current: \PublishPress\Stripe\StripeObject, type: string}&\PublishPress\Stripe\StripeObject) $balance The most recent information about the account's balance.
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\PublishPress\Stripe\StripeObject) $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\PublishPress\Stripe\StripeObject) $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|(object{active?: (object{action: string, cause: string, expected_deactivation_date: int}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $status_details
 ...
 * @property null|(object{id: string, last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\PublishPress\Stripe\StripeObject) $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<Account> of ApiResources
     *
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<AccountOwner> list of account owners
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
