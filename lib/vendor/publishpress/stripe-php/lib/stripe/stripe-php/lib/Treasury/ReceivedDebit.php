 ...
 * @property null|(object{balance?: string, billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PublishPress\Stripe\StripeObject), email: null|string, name: null|string}&\PublishPress\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\PublishPress\Stripe\StripeObject), issuing_card?: string, type: string, us_bank_account?: (object{bank_name: null|string, last4: null|string, routing_number: null|string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $initiating_payment_method_details
 * @property (object{debit_reversal: null|string, inbound_transfer: null|string, issuing_authorization: null|string, issuing_transaction: null|string, payout: null|string, topup: null|string}&\PublishPress\Stripe\StripeObject) $linked_flows
 * @property bool $livemode If the object exists in live mode, the value is <code>true</code>. If the object exists in test mode, the value is <code>false</code>.
 * @property string $network The network used for the ReceivedDebit.
 * @property null|(object{deadline: null|int, restricted_reason: null|string}&\PublishPress\Stripe\StripeObject) $reversal_details Details describing when a ReceivedDebit might be reversed.
 ...
 */
class ReceivedDebit extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<ReceivedDebit> of ApiResources
     *
