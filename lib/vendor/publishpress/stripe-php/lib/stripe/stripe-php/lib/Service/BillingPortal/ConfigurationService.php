...
namespace PublishPress\Stripe\Service\BillingPortal;
 ...
 */
class ConfigurationService extends \PublishPress\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\BillingPortal\Configuration>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\BillingPortal\Configuration
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
