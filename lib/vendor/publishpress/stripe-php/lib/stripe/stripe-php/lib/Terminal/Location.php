 ...
 * @property (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PublishPress\Stripe\StripeObject) $address
 * @property null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string, town: null|string}&\PublishPress\Stripe\StripeObject) $address_kana
 * @property null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string, town: null|string}&\PublishPress\Stripe\StripeObject) $address_kanji
 ...
 */
class Location extends \PublishPress\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<Location> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
