 ...
 * @property (object{monetary: null|(object{currency: string, value: int}&\PublishPress\Stripe\StripeObject), type: string}&\PublishPress\Stripe\StripeObject) $amount
 * @property (object{scope: (object{price_type?: string, prices?: ((object{id: null|string}&\PublishPress\Stripe\StripeObject))[]}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $applicability_config
 ...
 * @property string|\PublishPress\Stripe\Customer $customer ID of the customer receiving the billing credits.
 ...
 * @property null|string|\PublishPress\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this credit grant belongs to.
 ...
 */
class CreditGrant extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<CreditGrant> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
