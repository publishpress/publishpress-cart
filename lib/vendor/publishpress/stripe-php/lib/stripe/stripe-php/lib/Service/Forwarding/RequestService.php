...
namespace PublishPress\Stripe\Service\Forwarding;
 ...
 */
class RequestService extends \PublishPress\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\Forwarding\Request>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Forwarding\Request
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
