 ...
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $bbpos_wisepad3
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $bbpos_wisepos_e
 * @property null|(object{enabled: bool}&\PublishPress\Stripe\StripeObject) $cellular
 ...
 * @property null|(object{enabled: null|bool}&\PublishPress\Stripe\StripeObject) $offline
 * @property null|(object{end_hour: int, start_hour: int}&\PublishPress\Stripe\StripeObject) $reboot_window
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $stripe_s700
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $stripe_s710
 * @property null|(object{aed?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), aud?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), cad?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), chf?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), czk?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), dkk?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), eur?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), gbp?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), gip?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), hkd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), huf?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), jpy?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), mxn?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), myr?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), nok?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), nzd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), pln?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), ron?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), sek?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), sgd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject), usd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $tipping
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $verifone_m425
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $verifone_p400
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $verifone_p630
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $verifone_ux700
 * @property null|(object{splashscreen?: string|\PublishPress\Stripe\File}&\PublishPress\Stripe\StripeObject) $verifone_v660p
 * @property null|(object{enterprise_eap_peap?: (object{ca_certificate_file?: string, password: string, ssid: string, username: string}&\PublishPress\Stripe\StripeObject), enterprise_eap_tls?: (object{ca_certificate_file?: string, client_certificate_file: string, private_key_file: string, private_key_file_password?: string, ssid: string}&\PublishPress\Stripe\StripeObject), personal_psk?: (object{password: string, ssid: string}&\PublishPress\Stripe\StripeObject), type: string}&\PublishPress\Stripe\StripeObject) $wifi
 */
class Configuration extends \PublishPress\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<Configuration> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
