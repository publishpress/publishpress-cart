...
namespace PublishPress\Stripe\Service\Sigma;
 ...
 */
class ScheduledQueryRunService extends \PublishPress\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\Sigma\ScheduledQueryRun>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Sigma\ScheduledQueryRun
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
