...
namespace PublishPress\Stripe\TestHelpers;
 ...
 * @property (object{advancing?: (object{target_frozen_time: int}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $status_details
 */
class TestClock extends \PublishPress\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<TestClock> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
