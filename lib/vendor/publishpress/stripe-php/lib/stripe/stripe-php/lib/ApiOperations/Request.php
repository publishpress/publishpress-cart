...
namespace PublishPress\Stripe\ApiOperations;
...
trait Request
{
     ...
     *
     * @throws \PublishPress\Stripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    ...
    /**
     * @param string $url URL for the request
     * @param class-string< \PublishPress\Stripe\Collection|\PublishPress\Stripe\SearchResult > $resultClass indicating what type of paginated result is returned
     * @param null|array $params list of parameters for the request
     * @param null|array|string $options
     * @param string[] $usage names of tracked behaviors associated with this request
     *
     * @return \PublishPress\Stripe\Collection|\PublishPress\Stripe\SearchResult
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    {
        $opts = \PublishPress\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \PublishPress\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
