...
class FileService extends AbstractService
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\File>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\File
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    public function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\PublishPress\Stripe\Util\Util::flattenParams($params), 1, 0);
