 ...
 * @property \PublishPress\Stripe\StripeObject $metadata Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 * @property string $name The feature's name, for your own purpose, not meant to be displayable to the customer.
 */
class Feature extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<Feature> of ApiResources
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
