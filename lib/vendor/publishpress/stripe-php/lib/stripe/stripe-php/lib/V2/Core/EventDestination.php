 ...
 * @property null|(object{aws_account_id: string, aws_event_source_arn: string, aws_event_source_status: string}&\PublishPress\Stripe\StripeObject) $amazon_eventbridge Amazon EventBridge configuration.
 * @property null|(object{azure_partner_topic_name: string, azure_partner_topic_status: string, azure_region: string, azure_resource_group_name: string, azure_subscription_id: string}&\PublishPress\Stripe\StripeObject) $azure_event_grid Azure Event Grid configuration.
 ...
 * @property null|\PublishPress\Stripe\StripeObject $metadata Metadata.
 ...
 * @property null|(object{disabled?: (object{reason: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $status_details Additional information about event destination status.
 * @property string $type Event destination type.
 * @property int $updated Time at which the object was last updated.
 * @property null|(object{signing_secret?: string, url?: string}&\PublishPress\Stripe\StripeObject) $webhook_endpoint Webhook endpoint configuration.
 */
class EventDestination extends \PublishPress\Stripe\ApiResource
{
