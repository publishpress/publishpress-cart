...
namespace PublishPress\Stripe\Service\Radar;
 ...
 */
class ValueListItemService extends \PublishPress\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \PublishPress\Stripe\Collection<\PublishPress\Stripe\Radar\ValueListItem>
     *
     ...
     * @param null|RequestOptionsArray|\PublishPress\Stripe\Util\RequestOptions $opts
     *
     * @return \PublishPress\Stripe\Radar\ValueListItem
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
