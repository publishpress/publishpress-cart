 ...
 * @property null|(object{card: null|(object{restrictions: null|(object{brands_blocked: string[]}&StripeObject)}&StripeObject)}&StripeObject) $payment_method_options Payment-method-specific configuration.
