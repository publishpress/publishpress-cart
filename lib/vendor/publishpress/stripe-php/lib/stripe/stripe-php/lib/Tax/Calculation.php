 ...
 * @property null|\PublishPress\Stripe\Collection<CalculationLineItem> $line_items The list of items the customer is purchasing.
 ...
 * @property null|(object{amount: int, amount_tax: int, shipping_rate?: string, tax_behavior: string, tax_breakdown?: ((object{amount: int, jurisdiction: (object{country: string, display_name: string, level: string, state: null|string}&\PublishPress\Stripe\StripeObject), sourcing: string, tax_rate_details: null|(object{display_name: string, percentage_decimal: string, tax_type: string}&\PublishPress\Stripe\StripeObject), taxability_reason: string, taxable_amount: int}&\PublishPress\Stripe\StripeObject))[], tax_code: string}&\PublishPress\Stripe\StripeObject) $shipping_cost The shipping cost details for the calculation.
 ...
 * @property ((object{amount: int, inclusive: bool, tax_rate_details: (object{country: null|string, flat_amount: null|(object{amount: int, currency: string}&\PublishPress\Stripe\StripeObject), percentage_decimal: string, rate_type: null|string, state: null|string, tax_type: null|string}&\PublishPress\Stripe\StripeObject), taxability_reason: string, taxable_amount: int}&\PublishPress\Stripe\StripeObject))[] $tax_breakdown Breakdown of individual tax amounts that add up to the total.
 ...
 */
class Calculation extends \PublishPress\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \PublishPress\Stripe\Collection<CalculationLineItem> list of calculation line items
     *
     * @throws \PublishPress\Stripe\Exception\ApiErrorException if the request fails
     */
