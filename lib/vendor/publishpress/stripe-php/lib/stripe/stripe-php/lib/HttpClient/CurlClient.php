...
namespace PublishPress\Stripe\HttpClient;

use PublishPress\Stripe\Exception;
use PublishPress\Stripe\Stripe;
use PublishPress\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
     ...
     *   <li>\PublishPress\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
