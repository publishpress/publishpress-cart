...
{
    /**
     * @var \PublishPress\Stripe\StripeClientInterface
     */
    protected $client;

    /**
     * @var \PublishPress\Stripe\StripeStreamingClientInterface
     */
     ...
     *
     * @param \PublishPress\Stripe\StripeClientInterface $client
     */
     ...
     *
     * @return \PublishPress\Stripe\StripeClientInterface
     */
     ...
     * Gets the client used by this service to send requests.
     *
     * @return \PublishPress\Stripe\StripeStreamingClientInterface
     */
    ...
    protected function request($method, $path, $params, $opts, $schemas = null)
    {
        ...
        if (null !== $schemas && isset($schemas['request_schema'])) {
            $params = \PublishPress\Stripe\Util\Int64::coerceRequestParams($params, $schemas['request_schema']);
        }
