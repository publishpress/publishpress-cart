 ...
 * @property (object{card_logo: string, carrier_text: string, second_line: string}&\PublishPress\Stripe\StripeObject) $features
 ...
 */
class PhysicalBundle extends \PublishPress\Stripe\ApiResource
{
     ...
     *
     * @return \PublishPress\Stripe\Collection<PhysicalBundle> of ApiResources
     *
