 ...
 * @property (object{account_onboarding?: (object{collection_options?: (object{fields?: string, future_requirements?: string}&\PublishPress\Stripe\StripeObject), configurations: string[], refresh_url: string, return_url?: string}&\PublishPress\Stripe\StripeObject), account_update?: (object{collection_options?: (object{fields?: string, future_requirements?: string}&\PublishPress\Stripe\StripeObject), configurations: string[], refresh_url: string, return_url?: string}&\PublishPress\Stripe\StripeObject), type: string}&\PublishPress\Stripe\StripeObject) $use_case Hash containing usage options.
 */
class AccountLink extends \PublishPress\Stripe\ApiResource
{
