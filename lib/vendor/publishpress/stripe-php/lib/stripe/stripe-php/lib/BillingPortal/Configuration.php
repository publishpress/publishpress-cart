...
namespace PublishPress\Stripe\BillingPortal;
 ...
 * @property null|string|\PublishPress\Stripe\Application $application ID of the Connect Application that created the configuration.
 * @property (object{headline: null|string, privacy_policy_url: null|string, terms_of_service_url: null|string}&\PublishPress\Stripe\StripeObject) $business_profile
 ...
 * @property (object{customer_update: (object{allowed_updates: string[], enabled: bool}&\PublishPress\Stripe\StripeObject), invoice_history: (object{enabled: bool}&\PublishPress\Stripe\StripeObject), payment_method_update: (object{enabled: bool, payment_method_configuration: null|string}&\PublishPress\Stripe\StripeObject), subscription_cancel: (object{cancellation_reason: (object{enabled: bool, options: string[]}&\PublishPress\Stripe\StripeObject), enabled: bool, mode: string, proration_behavior: string}&\PublishPress\Stripe\StripeObject), subscription_update: (object{billing_cycle_anchor: null|string, default_allowed_updates: string[], enabled: bool, products?: null|((object{adjustable_quantity: (object{enabled: bool, maximum: null|int, minimum: int}&\PublishPress\Stripe\StripeObject), prices: string[], product: string}&\PublishPress\Stripe\StripeObject))[], proration_behavior: string, schedule_at_period_end: (object{conditions: (object{type: string}&\PublishPress\Stripe\StripeObject)[]}&\PublishPress\Stripe\StripeObject), trial_update_behavior: string}&\PublishPress\Stripe\StripeObject)}&\PublishPress\Stripe\StripeObject) $features
 ...
 * @property (object{enabled: bool, url: null|string}&\PublishPress\Stripe\StripeObject) $login_page
