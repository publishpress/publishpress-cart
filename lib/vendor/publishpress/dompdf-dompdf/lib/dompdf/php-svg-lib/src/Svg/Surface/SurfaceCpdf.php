...
namespace PublishPress\Svg\Surface;

use PublishPress\Svg\Document;
...
class SurfaceCpdf implements SurfaceInterface
{
    ...
    /** @var \PublishPress\Svg\Surface\CPdf */
    private $canvas;
    ...
    public function __construct(Document $doc, $canvas = null)
    {
        ...
        if (!$canvas) {
            $canvas = new \PublishPress\Svg\Surface\CPdf(array(0, 0, $w, $h));
