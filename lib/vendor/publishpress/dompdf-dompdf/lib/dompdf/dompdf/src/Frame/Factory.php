 ...
 */
namespace PublishPress\Dompdf\Frame;
...
use PublishPress\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use PublishPress\Dompdf\FrameReflower\Page as PageFrameReflower;
use PublishPress\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator  = "PublishPress\\Dompdf\\FrameDecorator\\$decorator";
        $reflower   = "PublishPress\\Dompdf\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\PublishPress\\Dompdf\\Positioner\\'.$type;
