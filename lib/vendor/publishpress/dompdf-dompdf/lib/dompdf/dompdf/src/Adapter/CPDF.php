...
namespace PublishPress\Dompdf\Adapter;

use PublishPress\Dompdf\Canvas;
use PublishPress\Dompdf\Dompdf;
use PublishPress\Dompdf\Exception;
use PublishPress\Dompdf\FontMetrics;
use PublishPress\Dompdf\Helpers;
use PublishPress\Dompdf\Image\Cache;
use PublishPress\FontLib\Exception\FontNotFoundException;

/**
 * PDF rendering interface
 *
 * PublishPress\Dompdf\Adapter\CPDF provides a simple stateless interface to the stateful one
...
class CPDF implements Canvas
{
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \PublishPress\Dompdf\Cpdf(
            $size,
            true,
     ...
     *
     * @return \PublishPress\Dompdf\Cpdf
     */
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \PublishPress\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \PublishPress\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \PublishPress\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \PublishPress\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \PublishPress\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \PublishPress\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \PublishPress\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
