    ...
    static function get_instance(Dompdf $dompdf, $paper, string $orientation, ?string $class = null)
    {
        ...
        if (isset($class) && class_exists($class, false)) {
            ...
            if (($backend === "auto" || $backend === "pdflib") &&
                ...
                $class = "PublishPress\\Dompdf\\Adapter\\PDFLib";
            }
                ...
                if (class_exists($backend, false)) {
                    ...
                    $class = "PublishPress\\Dompdf\\Adapter\\GD";
                } else {
                    $class = "PublishPress\\Dompdf\\Adapter\\CPDF";
                }
            }
        }
        ...
        if (!$class_interfaces || !in_array("PublishPress\\Dompdf\\Canvas", $class_interfaces)) {
            $class = "PublishPress\\Dompdf\\Adapter\\CPDF";
            $instance = new $class($paper, $orientation, $dompdf);
        }
