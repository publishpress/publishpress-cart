 ...
 */
namespace PublishPress\Dompdf\Image;

use PublishPress\Dompdf\Options;
use PublishPress\Dompdf\Helpers;
use PublishPress\Dompdf\Exception\ImageException;
...
class Cache
{
     ...
     * @param Options $options  An instance of PublishPress\Dompdf\Options
     *
