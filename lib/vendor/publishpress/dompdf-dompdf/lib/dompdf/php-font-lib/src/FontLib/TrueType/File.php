...
namespace PublishPress\FontLib\TrueType;

use PublishPress\FontLib\AdobeFontMetrics;
use PublishPress\FontLib\Font;
use PublishPress\FontLib\BinaryStream;
use PublishPress\FontLib\Table\Table;
use PublishPress\FontLib\Table\DirectoryEntry;
use PublishPress\FontLib\Table\Type\glyf;
use PublishPress\FontLib\Table\Type\name;
use PublishPress\FontLib\Table\Type\nameRecord;
...
class File extends BinaryStream {
  ...
  protected function readTable($tag) {
    ...
    if (!self::$raw) {
      ...
      $class = "PublishPress\\FontLib\\Table\\Type\\$name_canon";
      ...
      $class = "PublishPress\\FontLib\\Table\\Table";
    }
