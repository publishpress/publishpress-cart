...
test('RT-017 purchase subscription PayPal checkout flow annually sale price', { tag: ["@paypal","@regression"] }, async ({ page, request }) => {
  ...
  await fillCheckoutContact(page, config, 'tc017');
