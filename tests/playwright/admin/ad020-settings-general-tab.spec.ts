...
const testCase = adminTestsById.get('AD-020');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-020');
}

test('AD-020 Settings General Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
