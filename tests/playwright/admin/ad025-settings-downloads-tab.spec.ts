...
const testCase = adminTestsById.get('AD-025');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-025');
}

test('AD-025 Settings Downloads Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
