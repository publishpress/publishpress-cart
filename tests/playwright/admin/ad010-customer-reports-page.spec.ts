...
const testCase = adminTestsById.get('AD-010');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-010');
}

test('AD-010 Customer Reports Page', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
