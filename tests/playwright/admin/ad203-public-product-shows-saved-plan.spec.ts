...
const testCase = adminTestsById.get('AD-203');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-203');
}

test('AD-203 Public Product Shows Saved Plan', { tag: ["@admin","@admin-workflow"] }, async ({ page }) => {
