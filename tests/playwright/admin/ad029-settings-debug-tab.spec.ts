...
const testCase = adminTestsById.get('AD-029');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-029');
}

test('AD-029 Settings Debug Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
