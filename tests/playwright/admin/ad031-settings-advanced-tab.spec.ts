...
const testCase = adminTestsById.get('AD-031');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-031');
}

test('AD-031 Settings Advanced Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
