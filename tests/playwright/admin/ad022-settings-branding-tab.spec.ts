...
const testCase = adminTestsById.get('AD-022');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-022');
}

test('AD-022 Settings Branding Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
