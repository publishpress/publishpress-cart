...
const testCase = adminTestsById.get('AD-004');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-004');
}

test('AD-004 Product Categories', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
