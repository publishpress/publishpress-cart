...
const testCase = adminTestsById.get('AD-003');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-003');
}

test('AD-003 Add Product Editor', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
