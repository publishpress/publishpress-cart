...
const testCase = adminTestsById.get('AD-028');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-028');
}

test('AD-028 Settings Reports Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
