...
const testCase = adminTestsById.get('AD-027');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-027');
}

test('AD-027 Settings Integrations Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
