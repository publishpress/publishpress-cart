...
const testCase = adminTestsById.get('AD-040');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-040');
}

test('AD-040 Debug Log Viewer', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
