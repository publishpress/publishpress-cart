...
const testCase = adminTestsById.get('AD-041');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-041');
}

test('AD-041 Stripe Webhook Log Viewer', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
