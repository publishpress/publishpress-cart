...
const testCase = adminTestsById.get('AD-202');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-202');
}

test('AD-202 Product List Shows Created Product', { tag: ["@admin","@admin-workflow"] }, async ({ page }) => {
