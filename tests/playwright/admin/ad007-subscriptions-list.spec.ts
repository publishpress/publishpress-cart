...
const testCase = adminTestsById.get('AD-007');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-007');
}

test('AD-007 Subscriptions List', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
