...
const testCase = adminTestsById.get('AD-001');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-001');
}

test('AD-001 Dashboard Page', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
