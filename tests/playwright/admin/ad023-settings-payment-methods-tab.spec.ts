...
const testCase = adminTestsById.get('AD-023');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-023');
}

test('AD-023 Settings Payment Methods Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
