...
const testCase = adminTestsById.get('AD-021');

if (!testCase) {
  throw new Error('Missing admin test definition: AD-021');
}

test('AD-021 Settings Pages Tab', { tag: ["@admin","@admin-core"] }, async ({ page }) => {
