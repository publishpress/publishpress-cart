...
TEST_FILE="$PLUGIN_ROOT_DIR/tests/legacy/integration/ppcart-stripe-sync/ppcart-stripe-sync.php"
...
if command -v php >/dev/null 2>&1; then
    ...
    echo "Unable to find php or frankenphp to run Stripe sync tests." >&2
    exit 1
fi
