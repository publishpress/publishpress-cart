...
import {
	...
	accountSubscriptionsBlockStyleOptions,
	accountSubscriptionsItemLayoutOptions,
...
export default {
	...
	controls: [
		{
			...
			help: __(
				'Choose how subscription details open from this subscription list.',
				'publishpress-cart'
			),
		},
		{
			...
			options: [
				{
					label: __( 'Active / Trialing', 'publishpress-cart' ),
					value: 'all',
				},
				{
	...
	panels: [
		buildListStylePanel( {
			styleOptions: accountSubscriptionsBlockStyleOptions,
			styleHelp: __(
				'Applies a coordinated card / minimal / pill look.',
				'publishpress-cart'
			),
			itemLayoutOptions: accountSubscriptionsItemLayoutOptions,
			itemLayoutHelp: __(
