...
- [ ] Run `composer test:regression` to execute browser regression tests when checkout or payment flows changed (first-time setup: `composer test:regression:setup`; see [docs/dev/testing/regression-tests.md](../../docs/dev/testing/regression-tests.md))
...
- [ ] Monitor [GitHub Actions](https://github.com/publishpress/publishpress-cart/actions) and confirm all release and deployment workflows complete successfully
- [ ] Verify the [WordPress.org plugin page](https://wordpress.org/plugins/publishpress-cart/) shows the new version and updated release information
